...
const CartItem = () => {
  ...
  //   // Find the item id that we want to remove
  //   //Make sure it matches the i that is being passed in
  //   // delete that product

  //   setCart(
  //     cart.filter((cItem) => {
  //       if (cItem.id === itemToDelete) {
  //         setCartCount(cartCount - cItem.quantity);
  //       }
  //       return cItem.id !== itemToDelete;
  //     })
  //   );
